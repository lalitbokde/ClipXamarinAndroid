...
namespace WeClip.Droid
{
    ...
    public class AddDefaultEventPic : AppCompatActivity, Helper.OrientationManager.OrientationListener
    {
        public long EventID;
        ...
        private void BtnCapture_Click(object sender, EventArgs e)
        {
            if (_captureMode == CaptureMode.Photo)      // Capture Photo
            {
                ...
                _picture.PictureTakenCompleted += delegate
                {
                    ...
                    {
                        var uploadfile = new UploadEventFileBackGround(this, EventID, mediaFilePath);
                        uploadfile.Execute();
                    }
                    //  ResetCamera();
        ...
        private class UploadEventFileBackGround : AsyncTask<Java.Lang.Void, Java.Lang.Void, JsonResult>
        {
            private AddDefaultEventPic context;
            ...
            public UploadEventFileBackGround(AddDefaultEventPic context, long eventID, string uploadImagePath)
            {
