...
namespace WeClip.Droid
{
    ...
    public class EventCreateAddEventProfilePic : AppCompatActivity
    {
        ...
        {
            private EventCreateAddEventProfilePic context;

            public dialogeItemClickListner(EventCreateAddEventProfilePic context)
            {
