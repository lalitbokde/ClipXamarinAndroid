...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WeClip.Droid.Helper.RoundedTransformation, WeClip.Droid, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", RoundedTransformation.class, __md_methods);
	}


	public RoundedTransformation () throws java.lang.Throwable
	{
		super ();
		if (getClass () == RoundedTransformation.class)
			mono.android.TypeManager.Activate ("WeClip.Droid.Helper.RoundedTransformation, WeClip.Droid, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
