...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WeClip.Droid.Adapters.PWSliderAdapter, WeClip.Droid, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", PWSliderAdapter.class, __md_methods);
	}


	public PWSliderAdapter () throws java.lang.Throwable
	{
		super ();
		if (getClass () == PWSliderAdapter.class)
			mono.android.TypeManager.Activate ("WeClip.Droid.Adapters.PWSliderAdapter, WeClip.Droid, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
