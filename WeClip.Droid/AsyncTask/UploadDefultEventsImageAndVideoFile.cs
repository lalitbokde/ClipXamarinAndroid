...
{
    public class UploadDefultEventsImageAndVideoFile : AsyncTask<Java.Lang.Void, Java.Lang.Void, JsonResult>
    {
        ...
        public UploadDefultEventsImageAndVideoFile(Activity activity, List<string> uploadImagePath, int typeOfFile, long EventID)
        {
