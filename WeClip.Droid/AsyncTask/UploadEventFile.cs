...
{
    public class UploadEventFile : AsyncTask<Java.Lang.Void, Java.Lang.Void, JsonResult>
    {
        ...
        public UploadEventFile(Activity activity, List<string> uploadImagePath, int typeOfFile, long EventID)
        {
