    ...
    public class Util
    {
        ...
        public static Bitmap rotateImage(Bitmap b, int degrees)
        {
            if (degrees != 0 && b != null)
            {
                ...
                try
                {
                    Bitmap b2 = Bitmap.CreateBitmap(b, 0, 0, b.Width, b.Height, m, true);
                    if (b != b2)
                    {
                        b.Recycle();
                        b = b2;
        ...
        public static Bitmap transform(Matrix scaler, Bitmap source, int targetWidth, int targetHeight, bool scaleUp)
        {
            ...
            if (!scaleUp && (deltaX < 0 || deltaY < 0))
            {
                ...
                Bitmap b2 = Bitmap.CreateBitmap(targetWidth, targetHeight, Bitmap.Config.Argb8888);
            ...
            if (scaler != null)
            {
                ...
                b1 = Bitmap.CreateBitmap(source, 0, 0, source.Width, source.Height, scaler, true);
            }
            else
            {
                b1 = source;
            ...
            Bitmap b3 = Bitmap.CreateBitmap(b1,
                                            dx1 / 2,
                                            dy1 / 2,
                                            targetWidth,
                                            targetHeight);
