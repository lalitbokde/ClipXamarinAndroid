...
namespace WeClip.Droid.ImageResizer
{
    public class CropImageView : ImageViewTouchBase
    {
        ...
        private global::WeClip.Droid.ImageResizer.HighlightView.HitPosition motionEdge;
            ...
            switch (ev.Action)
            {
                case MotionEventActions.Down:
                    ...
                    for (int i = 0; i < hightlightViews.Count; i++)
                    {
                        ...
                        if (edge != global::WeClip.Droid.ImageResizer.HighlightView.HitPosition.None)
                        {
                            motionEdge = edge;
                            ...
                            mMotionHighlightView.Mode =
                                (edge == global::WeClip.Droid.ImageResizer.HighlightView.HitPosition.Move)
