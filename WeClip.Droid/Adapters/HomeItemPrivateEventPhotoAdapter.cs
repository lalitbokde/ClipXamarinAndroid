...
{
    class HomeItemPrivateEventPhotoAdapter : RecyclerView.Adapter
    {
        private FragmentActivity context;
        private long eventID;
        private List<string> listFiles;

        public HomeItemPrivateEventPhotoAdapter(List<string> listFiles, long eventID, FragmentActivity context)
        {
        ...
        {
            View v = LayoutInflater.From(parent.Context).Inflate(Resource.Layout.HomeItemPrivateEventPhotoItem, parent, false);
        ...
        private class PrivateEventPhotosViewHolder : RecyclerView.ViewHolder
        {
            ...
            {
                ivEventPhoto = v.FindViewById<ImageView>(Resource.Id.ivHomeItemPrivateEventPhoto);
            }
        }
    }
}